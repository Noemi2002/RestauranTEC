...
restaurante('La Esquina de Buenos Aires', [menu, argenita, [morcilla, chorizo, chinchulin, provoleta, lomito, entraña, ensaladas, vino]], [direccion, 'Iglesia Nuestra Se�ora de la Soledad, Calle 11 esquina Av. 4 Detr�s de la, San Jos�'], [lugar, 'Heredia'], [disposiciones, ['Pedidos por whatsapp']]).
...
restaurante('PetFriendly Bistro', [menu, 'Comida gourmet y opciones sin gluten', ['Salm�n a la parrilla', 'Ensalada de quinoa', 'Postre sin azúcar']], [direccion, 'Santa Ana'], [lugar, 'San Jose'], [disposiciones, ['Pet-friendly', 'área específica para mascotas']]).
...
%Para obtener la provincia donde esta el restaurante
