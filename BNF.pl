...
saludo(Oracion, Resultado) :- saludar2(Oracion, Res1), saludar4(Res1, Resultado).
saludo(Oracion, Resultado) :- saludar3(Oracion, Res1), saludar5(Res1, Resultado).
...
sintagma_nominal(Oracion, Resultado) :- sustantivo(Oracion, Res1, _), adjetivo(Res1, Res2), sintagma_descriptivo(Res2, Resultado).
sintagma_nominal(Oracion, Resultado) :- sustantivo(Oracion, Res1, _), adjetivo(Res1, Res2), sintagma_preposicional(Res2, Resultado).
sintagma_nominal(Oracion, Resultado) :- sustantivo(Oracion, Res1, _), adjetivo(Res1, Res2), sintagma_nominal(Res2, Res3), sintagma_preposicional(Res3, Resultado).
