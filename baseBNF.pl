...
% Adjetivos
adjetivo(["rico"|Rest], Rest).
adjetivo(["grande"|Rest], Rest).
adjetivo(["mediana"|Rest], Rest).
adjetivo(["saludable"|Rest], Rest).
adjetivo(["frio"|Rest], Rest).
adjetivo(["caliente"|Rest], Rest).
adjetivo(["asado"|Rest], Rest).
adjetivo(["picante"|Rest], Rest).
adjetivo(["dulce"|Rest], Rest).
adjetivo(["rojo"|Rest], Rest).
adjetivo(["verde"|Rest], Rest).
